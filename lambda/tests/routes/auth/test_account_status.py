...
@pytest.fixture
def route(mock_account_manager: MagicMock) -> AccountStatusRoute:
    return AccountStatusRoute(account_manager=mock_account_manager)


class TestAccountStatus:
    def test_returns_true_for_existing_account(
        self, route: AccountStatusRoute, mock_account_manager: MagicMock
    ) -> None:
    ...
    def test_returns_false_for_unknown_account(
        self, route: AccountStatusRoute, mock_account_manager: MagicMock
    ) -> None:
    ...
    def test_returns_400_for_missing_email(self, route: AccountStatusRoute) -> None:
        event = APIGatewayProxyEvent(
            {
                "httpMethod": "GET",
                "path": "/v1/account/status",
    ...
    def test_returns_400_for_null_query_params(self, route: AccountStatusRoute) -> None:
        event = APIGatewayProxyEvent(
            {
                "httpMethod": "GET",
                "path": "/v1/account/status",
...
class TestAccountStatusBind:
    def test_bind_registers_get_route(self, route: AccountStatusRoute) -> None:
        mock_api = MagicMock()
